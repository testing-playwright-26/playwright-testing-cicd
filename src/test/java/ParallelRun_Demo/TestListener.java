...
TestWatcher{
	...
	public void beforeTestExecution(ExtensionContext context) throws Exception {
	    ...
	    System.out.println(
	        "Test instance = " + context.getRequiredTestInstance()
	    );
       ...
       // System.out.println("Execution Exception : " + exception);
        ...
        if (exception.isPresent()) {
            ...
            if (cause instanceof AssertionFailedError) {
                ...
                AssertionFailedError assertionError = (AssertionFailedError) cause;
                ...
                String expected =
                        assertionError.getExpected().getStringRepresentation();

                String actual =
                        assertionError.getActual().getStringRepresentation();
                Allure.getLifecycle().updateTestCase(result -> {

                    result.setStatusDetails(
                        ResultsUtils.getStatusDetails(cause).orElse(null)
                    );
